...
// Album elements to be populated with text dynamically
...
var setCurrentAlbum = function(album) {
 ...
 var updateSeekPercentage = function($seekBar, seekBarFillRatio) {
    ...
    // makes sure percentage isn't less than 0 or greater than 100
    offsetXPercent = Math.max(0, offsetXPercent);
    offsetXPercent = Math.min(100, offsetXPercent);
    // convert percentage to a string and add % symbol
 ...
 var setupSeekBars = function() {
     ...
     $seekBars.click(function(event) {
         // determine proportion of the seek bar
         var offsetX = event.pageX - $(this).offset().left;
         var barWidth = $(this).width();
         // calculate the seek bar ratio
